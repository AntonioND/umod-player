...
macro(umod_search_toolchain_gba found_toolchain)
    ...
    if(EXISTS "${ARM_GCC_PATH}arm-none-eabi-gcc")
        message(STATUS "umod player: GBA toolchain found: ${ARM_GCC_PATH}")
        set(${found_toolchain} ON)
    else()
        message(STATUS "umod player: GBA toolchain not found")
        set(${found_toolchain} OFF)
    endif()
endmacro()


macro(umod_toolchain_gba)
